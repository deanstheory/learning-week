...
i2c = I2C(0, scl=machine.Pin(22), sda=machine.Pin(21), freq=400000)
...
def read_mpu6050():
    ...
    try:
        while True:
            ...
            print("X: %8.3f," %k_angle_x,"Y: %8.3f" %k_angle_y, end='\r')
            #print('\r{:.3f}, {:.3f}, {:.3f}, {:.3f}'.format(c_angle_x, c_angle_y, k_angle_x, k_angle_y), end='')
